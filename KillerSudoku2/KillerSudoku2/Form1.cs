        ...
        private void table5x5_Paint(object sender, PaintEventArgs e)
        {
            ...
            for (int i = 0; i <= bound1; i = i++)
            {
                for (int j = 0; j <= bound1; j++)
                {
                    if (matriz[i, j] == 'c')
                    {
                        e.Graphics.FillRectangle(Brushes.GreenYellow, i*35, j*35, 35, 35);
                    }
                    if (matriz[i, j] == 'l')
                    {
                        e.Graphics.FillRectangle(Brushes.Blue, i * 35, j * 35, 35, 35);
                    }
                    if (matriz[i, j] == 'r')
                    {
                        e.Graphics.FillRectangle(Brushes.Red, i * 35, j * 35, 35, 35);
                    }
                    if (matriz[i, j] == 'p')
                    {
                        e.Graphics.FillRectangle(Brushes.Purple, i * 35, j * 35, 35, 35);
                    }
                    if (matriz[i, j] == 'z')
                    {
                        e.Graphics.FillRectangle(Brushes.Green, i * 35, j * 35, 35, 35);
                    }
                    if (matriz[i, j] == 't')
                    {
                        e.Graphics.FillRectangle(Brushes.Turquoise, i * 35, j * 35, 35, 35);
                    }
                }
            }*/
        }
